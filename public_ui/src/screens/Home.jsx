...
const Home = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.heroTitle}>Let’s Fight Against Theft Together — Report, Prevent, Protect.</Text>
        <Text style={styles.heroText}>
          Thefttory connects citizens with law enforcement to create safer communities.
          Report incidents, track resolutions, and stay informed.
        </Text>
      </Animatable.View>

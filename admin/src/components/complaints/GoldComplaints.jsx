...
const GoldComplaints = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-6 text-blue-700"><GoldIcon /> Gold Complaints</h1>
      ...
      {complaints.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {complaints.map((complaint) => (
            <Link key={complaint._id} to={`/admin/complaints/gold/${complaint._id}`} className='hover-shadow-lg transition transform hover:scale-105'>
              <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200">
                <h2 className="text-xl font-semibold mb-2">{complaint.weight} grams</h2>
                <p><strong><GoldIcon/> Unique feature:</strong> {complaint.uniqueFeature}</p>
